      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-3">
            ...
            <div className='text-termo'>Ao criar uma conta no biscato, você está concordando com os nossos <Link to="/" className='a-link'>termos e condições</Link>.</div>
            <button className='btn btn-primary mt-3 mb-3'>Criar conta</button>
            <div className="text-border mb-3 mt-3 d-flex justify-content-center">
                <span className="text">ou criar conta com o google</span>
              </div>
            <button className='btn btn-light'><img src={google} alt="" />oogle</button>
            <div className='mt-5 text-center'>
             Ja tenho conta? <Link className='a-link' to="/login">Entrar</Link>.
            </div>
          </div>
        </div>
      </div>
